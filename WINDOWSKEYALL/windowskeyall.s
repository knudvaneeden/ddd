FORWARD INTEGER PROC FNProgramRunKeyShorthcutAutohotkeyCaseAllB( STRING s1 )
FORWARD PROC Main()
...
PROC Main()
 ...
 AddLine( '<WindowsKey + />                  ; Begin IME reconversion.' )
 ...
 AddLine( '<WindowsKey + Alt + 1>            ; Open the desktop and open the Jump List for the app pinned to the taskbar in the position indicated by the number 1.' )
 AddLine( '<WindowsKey + Alt + 2>            ; Open the desktop and open the Jump List for the app pinned to the taskbar in the position indicated by the number 2.' )
 AddLine( '<WindowsKey + Alt + 3>            ; Open the desktop and open the Jump List for the app pinned to the taskbar in the position indicated by the number 3.' )
 AddLine( '<WindowsKey + Alt + 4>            ; Open the desktop and open the Jump List for the app pinned to the taskbar in the position indicated by the number 4.' )
 AddLine( '<WindowsKey + Alt + 5>            ; Open the desktop and open the Jump List for the app pinned to the taskbar in the position indicated by the number 5.' )
 AddLine( '<WindowsKey + Alt + 6>            ; Open the desktop and open the Jump List for the app pinned to the taskbar in the position indicated by the number 6.' )
 AddLine( '<WindowsKey + Alt + 7>            ; Open the desktop and open the Jump List for the app pinned to the taskbar in the position indicated by the number 7.' )
 AddLine( '<WindowsKey + Alt + 8>            ; Open the desktop and open the Jump List for the app pinned to the taskbar in the position indicated by the number 8.' )
 AddLine( '<WindowsKey + Alt + 9>            ; Open the desktop and open the Jump List for the app pinned to the taskbar in the position indicated by the number 9.' )
 ...
 AddLine( '<WindowsKey + Alt + B>            ; Toggle HDR on or off (XBox Game related)' )
 ...
 AddLine( '<WindowsKey + C>                  ; Show "Chat" from Microsoft Teams' )
 ...
 AddLine( '<WindowsKey + Ctrl + ArrowLeft>   ; Switch between virtual desktops you have created on the le' )
 ...
 AddLine( '<WindowsKey + G>                  ; Show "XBox Game Bar" when a game is open' )
 ...
 s1 = Trim( s1 )
 //
 Message( FNProgramRunKeyShorthcutAutohotkeyCaseAllB( s1 ) ) // gives e.g. TRUE
END

// --- LIBRARY --- //

// library: program: run: key: shorthcut: autohotkey: case: all <description></description> <version control></version control> <version>1.0.0.0.5</version> <version control></version control> (filenamemacro=windowskeyall.s) [<Program>] [<Research>] [kn, ri, sa, 17-12-2022 01:22:24]
INTEGER PROC FNProgramRunKeyShorthcutAutohotkeyCaseAllB( STRING caseS )
 ...
 // e.g.  AddLine( '<WindowsKey + />                  ; Begin IME reconversion.' )
 ...
 // e.g.  AddLine( '<WindowsKey + Alt + 1>            ; Open the desktop and open the Jump List for the app pinned to the taskbar in the position indicated by the number 1.' )
 // e.g.  AddLine( '<WindowsKey + Alt + 2>            ; Open the desktop and open the Jump List for the app pinned to the taskbar in the position indicated by the number 2.' )
 // e.g.  AddLine( '<WindowsKey + Alt + 3>            ; Open the desktop and open the Jump List for the app pinned to the taskbar in the position indicated by the number 3.' )
 // e.g.  AddLine( '<WindowsKey + Alt + 4>            ; Open the desktop and open the Jump List for the app pinned to the taskbar in the position indicated by the number 4.' )
 // e.g.  AddLine( '<WindowsKey + Alt + 5>            ; Open the desktop and open the Jump List for the app pinned to the taskbar in the position indicated by the number 5.' )
 // e.g.  AddLine( '<WindowsKey + Alt + 6>            ; Open the desktop and open the Jump List for the app pinned to the taskbar in the position indicated by the number 6.' )
 // e.g.  AddLine( '<WindowsKey + Alt + 7>            ; Open the desktop and open the Jump List for the app pinned to the taskbar in the position indicated by the number 7.' )
 // e.g.  AddLine( '<WindowsKey + Alt + 8>            ; Open the desktop and open the Jump List for the app pinned to the taskbar in the position indicated by the number 8.' )
 // e.g.  AddLine( '<WindowsKey + Alt + 9>            ; Open the desktop and open the Jump List for the app pinned to the taskbar in the position indicated by the number 9.' )
 ...
 // e.g.  AddLine( '<WindowsKey + Alt + B>            ; Toggle HDR on or off (XBox Game related)' )
 ...
 // e.g.  AddLine( '<WindowsKey + C>                  ; Show "Chat" from Microsoft Teams' )
 ...
 // e.g.  AddLine( '<WindowsKey + Ctrl + ArrowLeft>   ; Switch between virtual desktops you have created on the le' )
 ...
 // e.g.  AddLine( '<WindowsKey + G>                  ; Show "XBox Game Bar" when a game is open' )
 ...
 // e.g.  s1 = Trim( s1 )
 // e.g.  //
 // e.g.  Message( FNProgramRunKeyShorthcutAutohotkeyCaseAllB( s1 ) ) // gives e.g. TRUE
 // e.g. END
 //
 // ===
 //
 ...
 */
 ...
 // e.g.  title = "FNProgramRunKeyShorthcutAutohotkeyCaseAllB( s1 ) help" // The help's caption
 // e.g.  x = 100 // Location
 // e.g.  y = 3 // Location
 // e.g.  //
 ...
 CASE caseS
  ...
  WHEN "<WindowsKey + Alt + ArrowDown>"                     AddLine( "Send, {LWin down}!ArrowDown{LWin up}" )
  WHEN "<WindowsKey + Alt + ArrowLeft>"                     AddLine( "Send, {LWin down}!ArrowLeft{LWin up}" )
  WHEN "<WindowsKey + Alt + ArrowRight>"                    AddLine( "Send, {LWin down}!ArrowRight{LWin up}" )
  WHEN "<WindowsKey + Alt + ArrowUp>"                       AddLine( "Send, {LWin down}!ArrowUp{LWin up}" )
  ...
  WHEN "<WindowsKey + Alt + PrtScn>"                        AddLine( "Send, {LWin down}!PrtScn{LWin up}" )
  WHEN "<WindowsKey + Alt + R>"                             AddLine( "Send, {LWin down}!R{LWin up}" )
  WHEN "<WindowsKey + ArrowDown>"                           AddLine( "Send, {LWin down}ArrowDown{LWin up}" )
  WHEN "<WindowsKey + ArrowLeft>"                           AddLine( "Send, {LWin down}ArrowLeft{LWin up}" )
  WHEN "<WindowsKey + ArrowRight>"                          AddLine( "Send, {LWin down}ArrowRight{LWin up}" )
  WHEN "<WindowsKey + ArrowUp>"                             AddLine( "Send, {LWin down}ArrowUp{LWin up}" )
  ...
  WHEN "<WindowsKey + Ctrl + ArrowDown>"                    AddLine( "Send, {LWin down}^ArrowDown{LWin up}" )
  WHEN "<WindowsKey + Ctrl + ArrowLeft>"                    AddLine( "Send, {LWin down}^ArrowLeft{LWin up}" )
  WHEN "<WindowsKey + Ctrl + ArrowRight>"                   AddLine( "Send, {LWin down}^ArrowRight{LWin up}" )
  WHEN "<WindowsKey + Ctrl + ArrowUp>"                      AddLine( "Send, {LWin down}^ArrowUp{LWin up}" )
  ...
  WHEN "<WindowsKey + Ctrl + Spacebar>"                     AddLine( "Send, {LWin down}^Spacebar{LWin up}" )
  ...
  WHEN "<WindowsKey + Escape>"                              AddLine( "Send, {LWin down}Escape{LWin up}" )
  ...
  WHEN "<WindowsKey + PrtScn>"                              AddLine( "Send, {LWin down}PrtScn{LWin up}" )
  ...
  WHEN "<WindowsKey + Shift + ArrowDown>"                   AddLine( "Send, {LWin down}+ArrowDown{LWin up}" )
  WHEN "<WindowsKey + Shift + ArrowLeft>"                   AddLine( "Send, {LWin down}+ArrowLeft{LWin up}" )
  WHEN "<WindowsKey + Shift + ArrowRight>"                  AddLine( "Send, {LWin down}+ArrowRight{LWin up}" )
  WHEN "<WindowsKey + Shift + ArrowUp>"                     AddLine( "Send, {LWin down}+ArrowUp{LWin up}" )
  ...
  WHEN "<WindowsKey + Shift + Spacebar>"                    AddLine( "Send, {LWin down}+Spacebar{LWin up}" )
  WHEN "<WindowsKey + Shift + V>"                           AddLine( "Send, {LWin down}+V{LWin up}" )
  WHEN "<WindowsKey + Spacebar>"                            AddLine( "Send, {LWin down}Spacebar{LWin up}" )
  ...
  OTHERWISE
   //
   Warn( "FNProgramRunKeyShorthcutAutohotkeyCaseAllB(", " ", "case", " ", ":", " ", caseS, ": not known" )
   //
   B = FALSE
   //
   RETURN( B )
