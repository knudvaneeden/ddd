...
REM
del ampersand_as_menu_quick_key_knud.zip
REM
REM ===
REM
REM zipping all these files
REM
pkzipc -add -dir ampersand_as_menu_quick_key_knud.zip *.*
REM
REM view the result in the zip file
REM
@ECHO "zipview ampersand_as_menu_quick_key_knud.zip"
REM
@ECHO "To install"
...
@ECHO ampersand_as_menu_quick_key.mac
