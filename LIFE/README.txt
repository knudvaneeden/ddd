...
1. -To install
     ...
     1. -Take the file life_knud.zip

     2. -And unzip it in any arbitrary directory

     3. -Then run the file zipinstalllife.bat

     4. -That will create a new file life_knud.zip
         in that directory
...
2. -The .ini file is the local file 'life.ini'
