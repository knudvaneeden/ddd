FORWARD INTEGER PROC FNProgramRunSearchGrepTsePcre2grepB()
FORWARD PROC Main()
...
PROC Main()
 Message( FNProgramRunSearchGrepTsePcre2grepB() ) // gives e.g. TRUE
END
...
// library: program: run: search: grep: tse: pcre2grep <description></description> <version control></version control> <version>1.0.0.0.1</version> <version control></version control> (filenamemacro=grepsemwarepcre2grep.s) [<Program>] [<Research>] [kn, ri, su, 04-12-2022 22:23:58]
INTEGER PROC FNProgramRunSearchGrepTsePcre2grepB()
 // e.g. PROC Main()
 // e.g.  Message( FNProgramRunSearchGrepTsePcre2grepB() ) // gives e.g. TRUE
 // e.g. END
 // e.g.
 // e.g. <F12> Main()
 //
 // ===
 //
 // Use case = Convert Pcre2grep grep output to TSE grep output.
 //
 ...
 */
 ...
 // ===
 //
 // e.g. // QuickHelp( HELPDEFFNProgramRunSearchGrepTsePcre2grepB )
 // e.g. HELPDEF HELPDEFFNProgramRunSearchGrepTsePcre2grepB
 // e.g.  title = "FNProgramRunSearchGrepTsePcre2grepB() help" // The help's caption
 // e.g.  x = 100 // Location
 // e.g.  y = 3 // Location
 // e.g.  //
 ...
 PushBlock()
 //
 // delete any lines not starting with a filename (e.g. C:, D:, E:, ...). Goal is to remove Pcre2grep warnings, ...
 //
 GotoBlockBegin()
