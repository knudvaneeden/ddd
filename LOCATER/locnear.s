/* *********************************************************************
    LocateNear - will locate paragraphs that contain a FIRST target
    (word or phrase), followed by a SECOND target (word or phrase),
    within any single paragraph, even if split across lines, with any
    number of text or whitespace characters separating them.  The
    found paragraphs will be copied to a file named "Found.txt" in the
    current directory.
********************************************************************* */
